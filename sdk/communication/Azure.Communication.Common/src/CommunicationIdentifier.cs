...
namespace Azure.Communication
{
    ...
    public abstract class CommunicationIdentifier : IEquatable<CommunicationIdentifier>
    {
        ...
        /// <returns>Returns <see cref="CommunicationUserIdentifier"/>, <see cref="PhoneNumberIdentifier"/>, <see cref="MicrosoftTeamsUserIdentifier"/>, <see cref="MicrosoftTeamsAppIdentifier"/>, <see cref="TeamsExtensionUserIdentifier"/>, or <see cref="UnknownIdentifier"/> based on the identifier type.</returns>
